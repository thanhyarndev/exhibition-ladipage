        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-4">
              <li><Link href="#" className="text-[14px] hover:text-cyan-400 transition-colors">Retail Inventory</Link></li>
              <li><Link href="#" className="text-[14px] hover:text-cyan-400 transition-colors">Warehouse Automation</Link></li>
              <li><Link href="#" className="text-[14px] hover:text-cyan-400 transition-colors">Manufacturing</Link></li>
              <li><Link href="#" className="text-[14px] hover:text-cyan-400 transition-colors">Supply Chain</Link></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-4">
              <li><Link href="#" className="text-[14px] hover:text-cyan-400 transition-colors">RFID Readers</Link></li>
              <li><Link href="#" className="text-[14px] hover:text-cyan-400 transition-colors">RFID Tags</Link></li>
              <li><Link href="#" className="text-[14px] hover:text-cyan-400 transition-colors">Antennas</Link></li>
              <li><Link href="#" className="text-[14px] hover:text-cyan-400 transition-colors">Software</Link></li>
            </ul>
          </div>
